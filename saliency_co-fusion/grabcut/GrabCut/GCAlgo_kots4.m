function [CurrRes,mask,m2] = GCAlgo_kots4( im, fixedBG2,fixedBG,otsu,para2,nu)
im=double(im);
...
fixedBG=nu-fixedBG;fac=ceil(nu/2);fac=nu-fac


prevLabel = double(fixedBG2);
prevLabel2 = double(fixedBG);
